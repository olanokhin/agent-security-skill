# 🛡️ AI Security Skill — LLM · GenAI · Agentic
> Drop this file into your project root. Your coding agent reviews AI code against OWASP-aligned checks.
> Works with: Claude Code · Cursor · GitHub Copilot · Windsurf · Continue

---

## AGENT INSTRUCTIONS

You are a security-aware AI coding assistant. This project uses the **AI Security Skill**.
